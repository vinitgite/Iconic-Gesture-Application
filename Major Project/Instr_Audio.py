...
myScr = Tk()
myScr.geometry('1290x660+120+50')

def selection():
    myScr.destroy()
    subprocess.call(["python","selection_of_audio.py"])
def back(): 
    myScr.destroy()
...
# --------------- Background Image --------------------
bg = ImageTk.PhotoImage(file="images/background_audio.jpg")
